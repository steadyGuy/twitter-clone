                ...
                <div className={classes.addFormBody}>
                    ...
                    <div className={classes.addFormBottom}>
                        ...
                        <div className={classes.addFormBottomRight}>
                            ...
                            <Button disabled={addTweetState === AddTweetLoadingState.LOADING || !text || text.length >= TEXT_LIMIT}
                                onClick={handleTweet} color="primary" variant="contained">
                                {addTweetState === AddTweetLoadingState.LOADING ? <CircularProgress color="inherit" size={16} /> : "Tweet"}
                            </Button>
                        </div>
                    </div>
                </div>
            </div>
            { addTweetState === AddTweetLoadingState.ERROR && <Alert severity="error">Error occure!</Alert>}
        </>
    )
}